...
class FormAssist
{
	...
	public function fileField($name,$attributes=array())
	{
      ...
      public function dropDownList($name, $options, $attributes=array(), $default="select")
	{
		$this->_str="";
		if(isset($this->_fields[$name]))
		{
      ...
      public function ajaxHelperDropDownList($name, $options, $attributes=array(), $default="select", $num=1)
	{
		$this->_str="";
		if(isset($this->_fields[$name]))
		{
	...
	public function ajaxDropDownList($list,$start,$end)
	{
     ...
     public function RadioGroup($name, $options, $attributes=array(), $vertical = false)
	{
		$this->_str="";
		if(isset($this->_fields[$name]))
		{
     ...
     public function CheckBoxList($name, $options, $attributes=array(), $vertical = false)
	{
		$this->_str="";
		if(isset($this->_fields[$name]))
		{
