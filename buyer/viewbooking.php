...
// Fetch bookings for this buyer with property details
$bookings = $dao->query("SELECT b.*, p.plocation, p.pprice, p.pimage 
                         FROM booking b 
                         LEFT JOIN property p ON b.pid = p.pid 
                         WHERE b.bid = $buyer_id 
...
<head>
    ...
    <title>My Bookings | Realty Hub</title>
...
<body>
            ...
            <nav class="navbar navbar-expand-lg">
                ...
                <div class="collapse navbar-collapse" id="navbarContent">
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active animate__animated animate__fadeInDown" href="viewbooking.php" style="animation-delay: 0.3s;">My Bookings</a>
                        </li>
                        <li class="nav-item">
    ...
    <div class="container">
        <div class="page-header">
            ...
            <p class="mb-0">View and manage your property bookings</p>
        </div>
        ...
        <?php else: ?>
            <div class="no-bookings">
                ...
                <p>You haven't made any property bookings yet. Start exploring properties and make your first booking!</p>
                <a href="view_property.php" class="btn btn-primary" style="background: linear-gradient(135deg, var(--primary), var(--primary-dark)); border: none; border-radius: 10px; padding: 12px 28px; font-weight: 600;">
